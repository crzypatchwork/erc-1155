...
contract ERC1155Mintable is ERC1155 {
    ...
    function mint(uint256 _initialSupply, uint256 _royalties, string memory _tokenUri) public returns(uint256 _id) {
        ...
        royalties[_id] = Royalties(msg.sender, _royalties);
        
        emit TransferSingle(msg.sender, address(0x0), msg.sender, _id, _initialSupply);
        emit metadataLog(_tokenUri, block.timestamp, _royalties, _id);
    ...
    function royaltyInfo(uint256 _tokenId, uint256 _salePrice) external view returns (address, uint256) {
        return (royalties[_tokenId].issuer, _salePrice*royalties[_tokenId].royalties/10000);
    }
